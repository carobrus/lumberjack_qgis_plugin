...
SOURCES = \
	__init__.py \
	Lumberjack.py Lumberjack_dialog.py

PLUGINNAME = Lumberjack

PY_FILES = \
	__init__.py \
	Lumberjack.py Lumberjack_dialog.py

UI_FILES = Lumberjack_dialog_base.ui
...
QGISDIR=C:\Users\Carolina\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
